					...
					<div class="container px-3 px-lg-5 my-5"
						...
						<div class="row gx-4 gx-lg-5 align-items-center">
							<div class="col-md-9">
								...
								<h1 class="display-5 fw-bolder">${video.title}</h1>
								<div class="fs-5 mb-4">
									<span><span style="font-weight: bold;">${video.views}</span>
								...
								<div class="d-flex">
									...
									<button type="button" class="btn btn-primary btn-like-share">
										<img
											src="https://2.pik.vn/20226cc94113-087e-4733-b7ae-5269605304cb.png">
										Share
									</button>
								</div>
							</div>
