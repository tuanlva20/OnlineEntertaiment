...
<body>
	...
	<form action="/ASSM-Nhom/client/favorite" method="post"></form>
					...
					<div class="thumbnail">
						...
						<div style="text-align: right; padding: 10px;">
							<button type="button" class="btn btn-success btn-like-share">
								<img src="/ASSM-Nhom/img/Unlike-20.png"
									formaction="/ASSM-Nhom/client/unlike"> Unlikee
							</button>

							<button type="button" class="btn btn-primary btn-like-share">
								<img src="/ASSM-Nhom/img/Share-20.png" alt="Hinh"> Share
							</button>
						</div>
